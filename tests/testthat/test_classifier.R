...
#   farff::writeARFF(dftest[dftest$class != "a", ], file_train, overwrite = TRUE)
#   train_test_on_dataset("weka.classifiers.trees.J48", file_train, file_test)
...
#   train_on_dataset("weka.classifiers.trees.J48", file_train)
...
#   farff::writeARFF(dftrain_na[1:10,], file_test, overwrite = TRUE)
#   train_test_on_dataset("weka.classifiers.trees.J48", file_train, file_test)
